  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        try {
          const sp = await getKV("sports");
          setSports(normalizeSports(sp));
    ...
    const unsubSports = subscribeKV("sports", (value) => setSports(normalizeSports(value)));
